...
public class App {
    ...
    public static void main(String[] args) {
        ...
        disciplina[0] = new Disciplina("POO", "Fundamentos de Programação ", 4); //armazenamento das 3 disciplinas no vetor
        ...
        turmas[0] = new Turma("Segunda-feira e Quarta-feira", "JK", 20, disciplina[0], prof[0]); //armazenamento das turmas com dados dos vetores anteriores
        ...
        Tabela.imprimirTabela(tabela); //mostra a grade de horários na tela
